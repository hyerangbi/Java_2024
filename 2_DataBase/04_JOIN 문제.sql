...
SELECT TO_DATE(SUBSTR(EMP_NO,1,2)) FROM EMPLOYEE;


SELECT EMP_ID, EMP_NAME,  EXTRACT (YEAR FROM SYSDATE) - EXTRACT(TO_DATE(SUBSTR(EMP_NO,1,2), 'RR'))+1 AS "나이" ,
...
-- 9. 보너스없고 직급 코드가 J4이거나 J7인 사원의 이름, 직급 명, 급여 조회(NVL 이용)
