...
public class BoardDao {
	...
	public Board selectBoard(Connection conn, int boardNo) {
		// select -> ResultSet(한 행) -> Board (Board를 return)
	...
	public Attachment selectAttachment(Connection conn, int boardNo) {
		// select -> ResultSet(한 행) -> Attachment (Attachment를 return)
		...
		try {
			...
			if(rset.next()) {
				...
				at.setOriginName(rset.getNString("origin_name"));
