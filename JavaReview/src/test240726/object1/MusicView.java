...
public class MusicView {
	...
	public void setMusic() {
		...
		String insertMusic = sc.nextLine();
		
		
		System.out.print("수정할 가수 명 : ");
		String singer = sc.next();
		
		Music m = mc.setMusic(title, new Music(insertMusic,singer));
		if(m == null) {
			System.out.println("수정할 곡이 없습니다.");
		}else {
			System.out.println(m.toString()+" 으로 변경되었습니다.");
		}
	}
