...
//		
//		String[] to = {"bc07889@gmail.com"};
//		message.setTo(to);
//		
//		String[] cc = {"bc07889@gmail.com"};
//		message.setCc(cc);
//		
//		sender.send(message);
//		
...
//		
//		// 이메일 찾기 시에 이메일 정보를 입력받아
//		//uuid(겹치지 않는 고유한 코드), 이메일, 시간을 데이터 베이스에 기록
//		// ex ) jj131315212 (uuid) / 이메일 @email.com / 2024/11/11 12:44 
//		
...
//				.toUriString();		
//		
//		// 두번째 인자를 true 로 보내면 html을 사용하겠다는 의미이다.
//		helper.setText("<a href='"+url+"'>사이트로 이동</a>", true);
//		
//		sender.send(message);
//		
//		return "redirect:/";
...
//		helper.setSubject("이메일 전송 테스트");
//		
//		DataSource source = new FileDataSource("C:\\Users\\user1\\");
